...
*/
  ...
  __constant__    int           ht_x_bin;
  __constant__    int           ht_y_bin;
  __constant__    float         ht_x_rez;
  __constant__    float         ht_y_rez;
  __constant__    float         ht_x_amp;
  __constant__    float         ht_y_amp;


EXT()  __host__ cuda_irt_histo_wk*     cuda_irt_histo_alloc
  (grid*)
{
...
EXT()  __host__ void                   cuda_irt_histo_free 
  (cuda_irt_histo_wk*)
{
...
EXT()  __host__ void                   cuda_irt_histo_data 
  (cuda_irt_histo_wk*, histogram*)
{
...
EXT()  __host__  wigner* cuda_irt_histo
  (cuda_irt_histo_wk*, Real cutoff, grid* g)
{
...
EXT()  __host__  Real  cuda_irt_histo_neg
  (cuda_irt_histo_wk*, Real cutoff)
{
